					...
					<div class="card-header">
						<div>
							...
							<p class="text-sm mb-0">
								Compra no. <b> {{ this.modal.id }}</b> de <b>{{ this.modal.fecha }} </b>
							</p>
						</div>
						<div class="d-flex justify-content-between align-items-center">
							<div>
								<span class="mb-2 text-xs"><strong>PROVEEDOR:</strong>
									<span class="text-dark font-weight-bold ms-2">{{ this.modal.proveedor }}</span></span>
							</div>

	...
	<AdminTemplate >
		<div slot="body">
			<div class="row">
							...
							<div class="d-lg-flex">
								...
								<div class="ms-auto my-auto mt-lg-0 mt-4">
									<div class="ms-auto my-auto">
										<a @click.prevent="openModal()" class="btn bg-gradient-primary btn-sm mb-0" target="_blank">+&nbsp; Usuario</a>
									</div>
								</div>
							</div>
						</div>
										...
										<table class="table table-flush dataTable-table" id="products-list">
											<thead class="thead-light">
												<tr>
													...
													<th><a class="dataTable-sorter">Email</a></th>
				...
				<ModalsFormUsuario :is-modal-visible.sync="isModalVisible" :formulario="form"></ModalsFormUsuario>
			</div>
		</div>
	</AdminTemplate>
</template>
